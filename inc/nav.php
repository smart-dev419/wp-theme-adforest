...
function adforest_themeMenu($theme_location) {
	...
	<li><a href="#"><i class="fa fa-bookmark"></i>Guides d\'achat<span class="badge">nouveau</span></a></li>
	
</ hr>
<li><i class="fa fa-star"></i>Evenements</li>
<ul>
	<li><a href="#">Rentree des classes 2021</a></li>
</ul>
</ hr>
<li><a href="#"><i class="fa fa-folder"></i>Tous les groupes</a></li>
<ul>
	<li><a href="#">High-Tech</a></li>
	<li><a href="#">Consoles & jeux vieo</a></li>
	<li><a href="#">Cdiscount</a></li>
	<li><a href="#">Cdiscount</a></li>
	<li><a href="#">Cdiscount</a></li>
	<li><a href="#">Cdiscount</a></li>
	<li><a href="#">Cdiscount</a></li>
...
<li><a href="#"><i class="fa fa-store"></i>Tous les marchands</a></li>
<ul>
	<li><a href="#">Cdiscount</a></li>
	<li><a href="#">Cdiscount</a></li>
	<li><a href="#">Cdiscount</a></li>
