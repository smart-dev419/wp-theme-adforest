...
if (!function_exists('ad_post_short_base_func')) {
    ...
    function ad_post_short_base_func($atts, $content = '') {
        ...
        if (isset($_GET['id'])) {
            ...
            if (get_post_field('post_author', $id) != get_current_user_id() && !is_super_admin(get_current_user_id())) {
                ...
                $sa_ad_url = get_post_meta($id, 'sa_adurl', true);
				$sa_ad_type = get_post_meta($id, 'sa_adtype', true);
				$sa_ad_coupon = get_post_meta($id, 'sa_adcoupon', true);
                $price = get_post_meta($id, '_adforest_ad_price', true);
                $sa_ad_discount = get_post_meta($id, 'sa_addiscount', true);
        ...
        if ($isCustom == 'no') {
		  ...
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
		   ...
		   <div class="row" >
            ...
            $ad_curreny_html .= '<div class="row">
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			 <label class="control-label">' . __('Price Discount', 'adforest') . '</label>
			 <input class="form-control" type="text" name="ad_discount" id="ad_discount" data-parsley-pattern="/^[0-9]+\.?[0-9]*$/" data-parsley-error-message="' . __('only numbers allowed.', 'adforest') . '" value="' . $sa_ad_discount . '">
		  </div>
		  </div>';
        } else {
  ...
  <section class="section-padding form-wizard">
		...
		$couponClass = ( isset($_GET['type']) && $_GET['type'] === 'coupon' ) ? 'btn btn-default btn-theme active' : 'btn btn-default' ;
		$dealClass = ( $_GET['type'] !== 'coupon' ) ? 'btn btn-default btn-theme active' : 'btn btn-default' ;
        ...
        $ad_post_modern_html .= '
            <div>
                ...
                <div class="row adttype-tabs">
        <input name="ad_type" id="ad_type" value="'. $sa_ad_type .'" hidden/>
        <span class="'.esc_attr($dealClass).'" data-tab="deal">Deal</span>
        <span class="'.esc_attr($couponClass).'" data-tab="coupon">Coupon</span>
    </div>
    
    <div class="row" data-tab-target="deal">
                    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
                        <label class="control-label">' . __('URL', 'adforest') . ' <span class="required">*</span></label>
                        <input class="form-control" placeholder="' . __('Enter url  character limit', 'adforest') . '" type="url" name="ad_url" id="ad_url" data-parsley-required="true" data-parsley-error-message="' . __('This field is required.', 'adforest') . '" value="' . $sa_ad_url . '" autocomplete="off">
                    </div>
                </div>

                <div class="row" data-tab-target="coupon">
                    <div class="col-md-7 col-lg-7 col-xs-12 col-sm-12">
                        <label class="control-label">' . __('URL', 'adforest') . ' <span class="required">*</span></label>
                        <input class="form-control" placeholder="' . __('Enter url  character limit', 'adforest') . '" type="url" name="ad_url" id="ad_url" data-parsley-required="true" data-parsley-error-message="' . __('This field is required.', 'adforest') . '" value="' . $sa_ad_url . '" autocomplete="off">
                    </div>
                    <div class="col-md-5 col-lg-5 col-xs-12 col-sm-12">
                        <label class="control-label">' . __('Coupon', 'adforest') . ' <span class="required">*</span></label>
                        <input class="form-control" placeholder="' . __('Enter coupon  character limit', 'adforest') . '" type="text" name="ad_coupon" id="ad_coupon" data-parsley-required="false" data-parsley-error-message="' . __('This field is required.', 'adforest') . '" value="' . $sa_ad_coupon . '" autocomplete="off">
                    </div>
                </div>
