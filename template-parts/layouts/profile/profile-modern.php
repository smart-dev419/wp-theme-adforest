...
<div class="sa-after-header">
	...
	<section class="sa-header-filters">
		<div class="row">
			<div class="container">
				<div id="filters">
					<li><a href="/author/<?php echo $author->user_login; ?>/?page=apercu">Aperçu</a></li>
					<li><a href="/author/<?php echo $author->user_login; ?>/?page=deals">Deals (<?php echo $ad_count; ?>)</a></li>
					<?php if ($current_user->ID == $author->ID ): ?>
					<li><a href="/author/<?php echo $author->user_login; ?>/?page=messages">Messages (<?php echo $ad_count; ?>)</a></li>
					<li><a href="/author/<?php echo $author->user_login; ?>/?page=packages">Packages</a></li>
					<li><a href="/author/<?php echo $author->user_login; ?>/?page=package_history">Package History</a></li>
					<li><a href="/author/<?php echo $author->user_login; ?>/?page=settings">Settings</a></li>
					<?php endif; ?>
				</div>
			</div>
		</div>
...
<section class="seller-public-profile">
	<div class="container">
		<?php 
		if ($_GET['page'] === 'deals') :
			sa_the_ads('author', $author_id);
		elseif ($_GET['page'] === 'messages') : 
			require trailingslashit(get_template_directory()) . 'template-parts/layouts/profile/profile-messages.php';
		else : 
		?>
		<div class="row">
