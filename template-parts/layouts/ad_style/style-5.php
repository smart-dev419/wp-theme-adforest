...
<section class="details-section"> 
	...
	if (get_post_meta($pid, '_adforest_ad_price_type', true) == "no_price" || ( get_post_meta($pid, '_adforest_ad_price', true) == "" && get_post_meta($pid, '_adforest_ad_price_type', true) != "free" && get_post_meta($pid, '_adforest_ad_price_type', true) != "on_call" )) {
								...
								<li><a href="javascript:void(0);"><span><?php echo __('Views', 'adforest');?></span> <?php 
				...
				<div class="col-lg-4 col-xs-12 col-md-3 col-sm-12">
					<div class="details-buttons">
						...
						<?php } else {
						?>TEST<div class="details-messages  <?php echo esc_attr($clsname);?>"><a class="btn btn-primary simple-message" href="javascript:void(0);" role="button" data-toggle="modal" data-target=".price-quote"><i class="fa fa-envelope"></i><?php echo __('Message', 'adforest');?></a>
