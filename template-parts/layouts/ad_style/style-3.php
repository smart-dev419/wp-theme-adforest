                                ...
                                <div class="pull-left <?php echo esc_attr($flip); ?> post-author">
                                    <ul>
                                      ...
                                      $total_view   =  $pre_view + $ad_view ;
                                            ...
                                            echo    '<span>'.$total_view.'</span>';
                                                } 
                                                else{

                                                    echo ' <span>'.adforest_getPostViews($pid).'</span>';
                                                }
                                ...
                                if (get_post_meta($pid, '_adforest_ad_status_', true) != "" && get_post_meta($pid, '_adforest_ad_status_', true) == 'active') {
                                    ...
                                    $contact_num = get_post_meta($pid, '_adforest_poster_contact', true);
                                        ...
                                        if (get_current_user_id() == "") {
                                            ...
                                            ?>
                                            <a href="<?php echo esc_url($redirect_url); ?>" class="btn btn-success  <?php echo esc_attr($ext_class); ?>" role="button" >
                                                <span class="glyphicon glyphicon-floppy-disk"></span><?php echo __('Send Message', 'adforest'); ?>
                                            </a>
                                            <?php
                                        } else {
                                            ?>
                                            <a href="javascript:void(0);" class="btn btn-success <?php echo esc_attr($ext_class); ?>" role="button" data-toggle="modal" data-target=".price-quote" >
